...
public class GreetResource {
	...
	@Uri("http://host.docker.internal:8080/greet")
	@SecureClient
	...
	public JsonObject outbound(@PathParam("name") final String name) {
	...
	public JsonObject onFailureOutbound(final String name) {
